...
#     print('need_map:',need_map)

    if need_map:
        return attn_output, attn_output_weights.sum(dim=1) / num_heads, attn_out, attn_weights
...
class MultiheadAttention(torch.nn.Module):
    ...
    def forward(self, query, key, value, key_padding_mask=None, need_map = False,
    ...
    Shape:
        ...
        if not self._qkv_same_embed_dim:
            return multi_head_attention_forward(
                ...
                key_padding_mask=key_padding_mask, need_weights=need_weights, need_map=need_map,
